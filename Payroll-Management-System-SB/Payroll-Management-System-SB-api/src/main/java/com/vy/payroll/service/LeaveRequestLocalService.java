...
public interface LeaveRequestLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LeaveRequestLocalServiceUtil} to access the leave request local service. Add custom service methods to {@link com.vy.payroll.service.impl.LeaveRequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public LeaveRequest createLeaveRequest(int request_id);
	...
	*/
	...
	public LeaveRequest deleteLeaveRequest(int request_id)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LeaveRequest fetchLeaveRequest(int request_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LeaveRequest getLeaveRequest(int request_id)
		throws PortalException;
