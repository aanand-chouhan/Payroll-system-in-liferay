...
/**
 * Provides the local service interface for PayslipDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PayslipDetailsLocalServiceUtil
...
public interface PayslipDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PayslipDetailsLocalServiceUtil} to access the payslip details local service. Add custom service methods to {@link com.vy.payroll.service.impl.PayslipDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public PayslipDetails addPayslipDetails(PayslipDetails payslipDetails);
	...
	*/
	...
	public PayslipDetails createPayslipDetails(long ctcId);
	...
	*/
	...
	public PayslipDetails deletePayslipDetails(long ctcId)
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public PayslipDetails deletePayslipDetails(PayslipDetails payslipDetails);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PayslipDetails fetchPayslipDetails(long ctcId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PayslipDetails getPayslipDetails(long ctcId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PayslipDetails> getPayslipDetailses(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public PayslipDetails updatePayslipDetails(PayslipDetails payslipDetails);
}