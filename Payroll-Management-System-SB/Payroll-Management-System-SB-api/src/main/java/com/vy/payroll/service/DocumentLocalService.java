...
public interface DocumentLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DocumentLocalServiceUtil} to access the document local service. Add custom service methods to {@link com.vy.payroll.service.impl.DocumentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocumentDocumentBlobModel getDocumentBlobModel(
