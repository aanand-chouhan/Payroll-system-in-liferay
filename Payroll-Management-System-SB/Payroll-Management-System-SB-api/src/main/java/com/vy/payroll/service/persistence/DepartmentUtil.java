...
public class DepartmentUtil {
	...
	*/
	public static Department create(int dno) {
	...
	*/
	public static Department remove(int dno)
		throws com.vy.payroll.exception.NoSuchDepartmentException {
	...
	* @throws NoSuchDepartmentException if a department with the primary key could not be found
	*/
	public static Department findByPrimaryKey(int dno)
		throws com.vy.payroll.exception.NoSuchDepartmentException {
	...
	*/
	public static Department fetchByPrimaryKey(int dno) {
	...
	*/
	...
	static {
		...
		ServiceTracker<DepartmentPersistence, DepartmentPersistence> serviceTracker =
			new ServiceTracker<DepartmentPersistence, DepartmentPersistence>(bundle.getBundleContext(),
				DepartmentPersistence.class, null);
