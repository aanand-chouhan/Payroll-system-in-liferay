...
public class DocumentLocalServiceWrapper implements DocumentLocalService,
	...
	*/
	@Override
	public com.vy.payroll.model.Document addDocument(
	...
	*/
	@Override
	public com.vy.payroll.model.Document createDocument(long docId) {
	...
	*/
	@Override
	public com.vy.payroll.model.Document deleteDocument(
		com.vy.payroll.model.Document document) {
	...
	*/
	@Override
	public com.vy.payroll.model.Document deleteDocument(long docId)
	...
	*/
	...
	@Override
	public com.vy.payroll.model.Document fetchByEmpId(long eno)
		throws com.vy.payroll.exception.NoSuchDocumentException {
		return _documentLocalService.fetchByEmpId(eno);
	}

	@Override
	public com.vy.payroll.model.Document fetchDocument(long docId) {
		return _documentLocalService.fetchDocument(docId);
	}

	@Override
	public java.util.List<com.vy.payroll.model.Document> findByDocumentEmpId(
		long eno) {
		return _documentLocalService.findByDocumentEmpId(eno);
	}

	@Override
	public java.util.List<com.vy.payroll.model.Document> findByEmpId(long eno) {
		return _documentLocalService.findByEmpId(eno);
	}
	...
	*/
	@Override
	public com.vy.payroll.model.Document getDocument(long docId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _documentLocalService.getDocument(docId);
	}

	@Override
	public com.vy.payroll.model.DocumentDocumentBlobModel getDocumentBlobModel(
		java.io.Serializable primaryKey) {
		return _documentLocalService.getDocumentBlobModel(primaryKey);
	}
	...
	*/
	@Override
	public java.util.List<com.vy.payroll.model.Document> getDocuments(
		int start, int end) {
	...
	*/
	...
	public int isDocReviewed(int eno) {
		return _documentLocalService.isDocReviewed(eno);
	}

	@Override
	public int updateDocsReview(int eno) {
		return _documentLocalService.updateDocsReview(eno);
	}
	...
	*/
	@Override
	public com.vy.payroll.model.Document updateDocument(
		com.vy.payroll.model.Document document) {
