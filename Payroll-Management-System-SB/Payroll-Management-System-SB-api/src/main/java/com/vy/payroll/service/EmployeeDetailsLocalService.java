...
public interface EmployeeDetailsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeDetailsLocalServiceUtil} to access the employee details local service. Add custom service methods to {@link com.vy.payroll.service.impl.EmployeeDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public EmployeeDetails createEmployeeDetails(long eno);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public EmployeeDetails deleteEmployeeDetails(long eno)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeDetails fetchEmployeeDetails(long eno);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeDetails getEmployeeDetails(long eno)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EmployeeDetailsImageBlobModel getImageBlobModel(
