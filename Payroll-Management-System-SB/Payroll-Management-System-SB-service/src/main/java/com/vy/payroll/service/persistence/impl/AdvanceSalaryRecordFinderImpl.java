...
public class AdvanceSalaryRecordFinderImpl extends AdvanceSalaryRecordFinderBaseImpl implements AdvanceSalaryRecordFinder{
	private static final String UPDATEISCHECKED="com.vy.payroll.service.persistence.AdvanceSalaryRecordFinder.updateIsViewed"; 
	private static final String ISREQUESTVIEWED="com.vy.payroll.service.persistence.AdvanceSalaryRecordFinder.IsRequestViewed";
	private static final String GETADVANCESALANDLEAVEREQ="com.vy.payroll.service.persistence.AdvanceSalaryRecordFinder.getAdvanceSalAndLeaveReq";
		...
		Session session=null;
		  try{
		   ...
		   System.out.println("3 step");
		    sqlQuery.addEntity("AdvanceSalaryRecord",AdvanceSalaryRecordImpl.class);
	...
	public List<Object[]> AdvanceSalAndLeaveReqData() {
		Session session=null;
		  try{
		   //open ORM Session
		     session=openSession();
		    //get sql query return in default.xml
		   String sql=CustomSQLUtil.get(getClass(), GETADVANCESALANDLEAVEREQ);
		   System.out.println("1 step "+sql);
		   SQLQuery sqlQuery=session.createSQLQuery(sql);
		   System.out.println("2 step");
		   sqlQuery.setCacheable(false);
