...
import com.vy.payroll.service.DocumentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vy.payroll.service.impl.DocumentLocalServiceImpl}.
 * </p>
 *
...
public abstract class DocumentLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vy.payroll.service.DocumentLocalServiceUtil} to access the document local service.
	 */
	...
	public DocumentDocumentBlobModel getDocumentBlobModel(
		...
		try {
			...
			return (DocumentDocumentBlobModel)session.get(DocumentDocumentBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.vy.payroll.model.Document",
			documentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.vy.payroll.model.Document");
	}
