			  ...
			  /*	ds=getPortletContext().getRequestDispatcher(path);
				...
				*/
				...
				if(uName.equals(listEmp.get(0).getEmail())&&pwd.equals(listEmp.get(0).getPassword())) {
					...
					request.getServletContext().setAttribute("eNO", listEmp.get(0).getEno());
					/*session.setAttribute("eID", listEmp.get(0).getEid());
					session.setAttribute("eNO", listEmp.get(0).getEno());
